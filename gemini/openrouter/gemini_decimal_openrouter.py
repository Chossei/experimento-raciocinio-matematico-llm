...
def carregar_openrouter_key():
    """Carrega a chave OPEN_ROUTER_API_KEY_2 de forma robusta procurando nos caminhos padrão ou variáveis de ambiente."""
    candidatos = [
...
dados_api = [
    ...
    {"modelo": "gemini-3.1-pro-preview", "input_usd": 2.00, "output_usd": 12.00, "rpm": 50, "rpd": 1000},
